...
# Training 📈
Machine Learning algorithms like Logistic Regression, Support Vector Machine(Support Vector Classifier in this case), K-Nearest Neighbours and Ensemble Methods like AdaBoost,GradientBoost,Random Forest, Extreme Gradient Boost(XGBoost) and CatBoost were used in this project.The models were trained on the training data and were tested on the testing set.
# Evaluation 🔬
